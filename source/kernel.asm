...
; ==================================================================
	...
	%DEFINE NOM_GRUPO 'Manjaro'	; OS version number
...
option_screen:
	...
	mov dx, 0			; We want a two-option dialog box (OK or Cancel)
	call os_dialog_box
	...
	os_init_msg		db 'Bienvenido al SO', 0
	os_version_msg		db 'Grupo ', NOM_GRUPO, 0

	dialog_string_1		db 'Gracias por usar el SO grupo Manjaro', 0
	dialog_string_2		db 'Presione OK para ingresar', 0
	dialog_string_3		db 'al menu de opciones', 0
...
app_selector:
	...
	mov bx, os_version_msg
	mov cx, 11111111b		; Colour: white text on light blue
	call os_draw_background
...
not_bas_extension:
	...
	kerndlg_string_2	db 'KERNEL.BIN is the core of OS, and', 0
