...
; =====================================================================
	...
	help_text		db 'Ingrese CALC, BEEP, APAGAR o SALIR', 13, 10, 0
	...
	finished_msg		db '>>> Programa terminado. Presione cualquier tecla', 0

	version_msg		db 'Manjaro OS', 13, 10, 0
	
	beep_string		db 'BEEP', 0
